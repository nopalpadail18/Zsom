...
function submit() {
    axiosClient.post(route("group.create"), form).then(() => {
        closeModal();
    });
}
                            ...
                            <DialogPanel
                                ...
                                <div class="p-4">
                                    <div class="mb-3">
                                        ...
                                        <TextInput v-model="form.name" placeholder="Group Name" type="text"
                                            class="w-full block mt-1" required autofocus />
                                    </div>

                                    <div class="mb-3">
                                        <label for="auto_approval">
                                            <Checkbox v-model="form.auto_approval" label="Auto Approval" id="auto_approval" checked />
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <InputTextarea v-model="form.about" placeholder="About Group"
